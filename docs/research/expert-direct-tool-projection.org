...
#+approval_base_blob: e1f80b32f6bee69cff8cdf237f10d2b60f83f6de
...
5. Effectful experts via the tool path get =effectful_batch_unsupported=
   ...
   *Design implication of the operator's preference:* relaxing the rule is a
   ...
   under today's abort-on-failure semantics. This question stays open for
   the design gate, steered by the operator's preference against the
   current restriction.
