...
This does **not** complete #377. Recursive/delegated experts, aggregate nested
work budgets, evidence-aware applicability rules, explicit metered model
fallback, invocation lineage, and per-expert unregister remain open. The
expert-guided advisory bridge in #459 composes on top of this leaf runtime.
